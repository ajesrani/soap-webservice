 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://rpc.ws.soa.com/", wsdlLocation = "http://localhost:8080/SOAPWebService/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://rpc.ws.soa.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SOAPWebService/ws/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://rpc.ws.soa.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rpc.ws.soa.com/", "HelloPort"), Hello.class, features);
    }
